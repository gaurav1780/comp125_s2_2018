...
objectives:
- Welcome to the unit
- Recapping prerequisite knowledge
- Installing the require software
...
## First java projet in Eclipse

We have recorded a short video to describe the process of creating a java project in Eclipse IDE.
