...
\usepackage{myOptions} % always add as LAST package} % always add as LAST package

\def\unit{WCOM125/COMP125 \vskip 0.5cm Fundamentals of Computer Science}
\def\authoredby{Gaurav Gupta}

\myTitle[\unit][\topic][\authoredby]
...
\end{tikzpicture} \egroup
\newpage
\section{Sample solutions for exercises}
\shipoutAnswer
\end{document}	
